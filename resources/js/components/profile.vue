    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="card card-widget widget-user shadow-lg">
              ...
              <div class="widget-user-header text-white" style="background: url('./img/academictalk.jpg')">
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="file" class="form-input" id="profilephoto">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <button  @click.prevent="UpdateInfo" class="btn btn-danger">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
